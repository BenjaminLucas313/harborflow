...
import { getEficienciaMetrics } from "@/modules/metrics/admin-service";
...
export async function GET(req: NextRequest): Promise<NextResponse> {
  try {
    ...
    const data = await getEficienciaMetrics(session.user.companyId, mes, anio);
    ...
    console.error("[GET /api/metricas/eficiencia]", err);
