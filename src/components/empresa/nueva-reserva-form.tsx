...
export function NuevaReservaForm({ trips, presetTripId }: Props) {
  ...
  const vibrateCancel = useVibrate();
      ...
      <div className="rounded-2xl border border-border bg-card p-6 space-y-5">
        ...
        <div className="flex gap-3">
          ...
          <Link
            ...
            onClick={vibrateCancel.trigger}
            className={`rounded-xl border border-border px-5 py-2.5 text-sm font-medium hover:bg-muted transition-colors ${vibrateCancel.className}`}
          >
            Cancelar
          </Link>
        </div>
